        ...
        <div className='row mt-3'>
          <div className='col'>
            <h3 className='brew-header text-center header-text'>
              {length === 0 ? 'This brewniverse doesn\'t exist yet!' : `${capitalized} Brewniverse`} <span onClick={this.sendSub} className='btn sub-button galaxy-indigo'>{userChannels.includes(tag) ? <i className="fas fa-minus sub-button-icon"></i> : <i className="fas fa-plus sub-button-icon"></i>}</span></h3>
